"""
Constructs the options for a NiiVue instance.

This module sets up getters and setters for all of the configurable options
of a NiiVue instance. All options are constructed with default values. This
module should not be editted directly.
"""
